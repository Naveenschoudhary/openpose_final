...
# Ampere (CUDA >= 11)
set(AMPERE "80 86")
# Ada Lovelace (CUDA >= 12)
set(LOVELACE "89")
# Hopper (CUDA >= 12)
set(HOPPER "90")
if (UNIX AND NOT APPLE)
  set(Caffe_known_gpu_archs "${KEPLER} ${MAXWELL} ${PASCAL} ${VOLTA} ${TURING} ${AMPERE} ${LOVELACE} ${HOPPER}")
...
function(caffe_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Kepler" "Maxwell" "Pascal" "Volta" "Turing" "Ampere" "Lovelace" "Hopper" "All" "Manual")
  ...
  elseif (${CUDA_ARCH_NAME} STREQUAL "Lovelace")
    set(__cuda_arch_bin ${LOVELACE})
  elseif (${CUDA_ARCH_NAME} STREQUAL "Hopper")
    set(__cuda_arch_bin ${HOPPER})
...
macro(caffe_cuda_compile objlist_variable)
  ...
  if (UNIX OR APPLE)
    ...
    # Add C++14 support for CUDA 11+
    if(CUDA_VERSION VERSION_GREATER "10.99")
      list(APPEND CUDA_NVCC_FLAGS -std=c++14)
      # Add flags to support newer CUDA versions
      list(APPEND CUDA_NVCC_FLAGS -Wno-deprecated-gpu-targets -D_FORCE_INLINES)
    endif()
  endif ()
