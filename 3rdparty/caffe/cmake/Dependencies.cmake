...
if(BUILD_python)
  if(NOT "${python_version}" VERSION_LESS "3.0.0")
    ...
    if(${PYTHONLIBS_VERSION_STRING} VERSION_GREATER_EQUAL "3.12.0")
      message(STATUS "Detected Python 3.12+, using specific configuration")
      # Use PyBind11 instead of Boost.Python for Python 3.12+
      add_definitions(-DUSE_PYBIND11)
      # Check if pybind11 is already available (included via OpenPose)
      if(NOT TARGET pybind11::pybind11)
        add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/../../3rdparty/pybind11 pybind11-build)
      endif()
      set(HAVE_PYTHON TRUE)
    else()
      # Try standard Boost.Python for older Python versions
  ...
  if(PYTHONLIBS_FOUND AND NUMPY_FOUND AND (Boost_PYTHON_FOUND OR TARGET pybind11::pybind11))
    set(HAVE_PYTHON TRUE)
    if(BUILD_python_layer)
      list(APPEND Caffe_DEFINITIONS PRIVATE -DWITH_PYTHON_LAYER)
      list(APPEND Caffe_INCLUDE_DIRS PRIVATE ${PYTHON_INCLUDE_DIRS} ${NUMPY_INCLUDE_DIR})
      list(APPEND Caffe_LINKER_LIBS PRIVATE ${PYTHON_LIBRARIES})
      if(TARGET pybind11::pybind11)
        # Using pybind11
        list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${pybind11_INCLUDE_DIRS})
      else()
        # Using Boost.Python
        list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${Boost_INCLUDE_DIRS})
        list(APPEND Caffe_LINKER_LIBS PUBLIC ${Boost_LIBRARIES})
